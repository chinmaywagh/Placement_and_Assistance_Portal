                ...
                <tbody>
                    <c:forEach var="intern" items="${listIntern}">
                               ...
                               <div class="table_head1" ><c:out value="${intern.intern_role}"/>
                                     ...
                                     <form action="UserInternApplyServlet" method="post">
                                        
                                        <input type="hidden" value="<%=session.getAttribute("uid") %>"name="uid" id="uid"/>
                       <button class="button-two"type="submit" style="margin:30px 0 30px 30px"class="form-submit" ><span>Apply</span></button>
                                                   </form>
